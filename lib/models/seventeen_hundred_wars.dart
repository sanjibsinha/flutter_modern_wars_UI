...
List<SeventeenHundredWars> seventeenHundredWars = [
  SeventeenHundredWars(
    ...
    place: 'Europe',
    howManyDied: 100000,
    description: 'Who would be to the throne of Spain following the death of the childless Charles II;'
  ...
  SeventeenHundredWars(
    ...
    place: 'Europe',
    howManyDied: 10000,
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vestibulum metus ac quam laoreet accumsan. Sed quis ultrices massa, quis elementum nunc. Nam a massa varius lacus suscipit fringilla.',
    weapons: weapons,
