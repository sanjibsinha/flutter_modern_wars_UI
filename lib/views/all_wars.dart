...
import 'package:flutter_modern_wars_UI/controllers/gesturedetector_controller.dart';
import 'package:flutter_modern_wars_UI/models/nineteen_hundred_wars.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      GestureDetectorController(headLine: '1700', gestureWidget: SeventeenHome(),),
                      GestureDetectorController(headLine: '1800', gestureWidget: AboutAllWars(),),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: <Widget>[
                      GestureDetectorController(headLine: '1900', gestureWidget: AboutAllWars(),),
                      GestureDetectorController(headLine: 'Cyber War', gestureWidget: CyberWarPage(),),
                    ],
                  ),
                ],
              ),
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  NineteenHundredWars nineteenHundredWar = nineteenHundredWars[index];
                  return Container(
